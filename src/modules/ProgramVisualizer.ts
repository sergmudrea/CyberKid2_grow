...
// ============================================================================
// ВИЗУАЛИЗАТОР ПРОГРАММЫ – ОТОБРАЖАЕТ ТРАЕКТОРИЮ ВЫПОЛНЕНИЯ НА КАРТЕ
// ============================================================================
// - Получает список команд (Command[]) и отображает на игровом поле стрелки
// - Показывает путь, который пройдёт игрок при выполнении программы
// - При выходе за границу или столкновении рисует красный крестик ❌
// ============================================================================
  ...
  public updateVisuals(
    ...
    for (const cmd of commands) {
      ...
      if (newCol >= 0 && newCol < width && newRow >= 0 && newRow < height) {
        ...
        // Выход за границу – рисуем крестик
        ...
        break; // дальнейшие команды не рисуем
      }
    }
  }
