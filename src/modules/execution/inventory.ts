...
// ============================================================================
// Все команды работают с учётом текущей позиции игрока и его инвентаря.
// В патче 2.0 изменений нет, но сохранена полная совместимость.
// ============================================================================
...
export class InventoryExecutor {
  ...
  public executeUseKey(lastDirection: 'up' | 'down' | 'left' | 'right'): 'ok' {
    // Определяем клетку впереди игрока (направление корпуса, не башни, т.к. ключ физический)
    let dx = 0, dy = 0;
